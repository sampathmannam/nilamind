    ...
    <div className="glass p-5 rounded-2xl space-y-3 shadow-lg" id="settings-feedback">
      ...
      >
        <div className="space-y-0.5">
          ...
          <div className="text-xs text-slate-500">Opens GitHub. For bugs &amp; ideas — please don't include anything private.</div>
        </div>
      ...
      >
        <div className="space-y-0.5">
          ...
          <div className="text-xs text-slate-500">Open source under Apache-2.0 — read it or build it yourself.</div>
        </div>
        <ExternalLink className="w-4 h-4 text-slate-500 shrink-0" />
      </a>
