      ...
      <div className="border border-line rounded-xl p-3 bg-page space-y-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium text-ink-2">{pinOn ? "PIN lock is on" : "PIN lock is off"}</span>
          </div>
        ...
        {mode === "setting" && (
          <div className="space-y-2 pt-1">
            <input
              ...
              className="w-full glass rounded-lg px-3 py-2.5 text-sm text-ink tracking-widest placeholder:tracking-normal placeholder:text-slate-600 focus:outline-none focus:border-blue-500/50"
            />
            <input
            ...
            <div className="flex gap-2">
              ...
              <button onClick={doSetPin} disabled={busy} id="settings-pin-save" className="flex-1 bg-blue-600 hover:bg-blue-500 disabled:bg-fill text-white text-xs font-bold py-2 rounded-lg cursor-pointer flex items-center justify-center gap-1.5">
