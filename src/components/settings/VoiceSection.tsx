    ...
    <div className="glass p-5 rounded-2xl space-y-4 shadow-lg" id="settings-voice">
      ...
      <div className="border border-line rounded-xl p-3 flex items-center justify-between bg-page">
        <div className="space-y-0.5">
          <div className="text-sm font-medium text-ink-2">Read aloud</div>
          <div className="text-xs text-ink-faint">Nila speaks replies; read-aloud buttons appear.</div>
        </div>
        <button
      ...
      <div className="border border-line rounded-xl p-3 bg-page space-y-1.5" id="settings-heynila">
        <div className="flex items-center justify-between">
          <div className="text-xs font-medium text-ink-2">"Hey Nila" wake word</div>
          <button
      ...
      {prefs.enabled && (
        <>
          ...
          {(voices.length > 0 || afHeart) && (
            <div className="border border-line rounded-xl p-3 bg-page space-y-2" id="settings-voice-picker">
              <div className="text-xs font-medium text-ink-2">Nila's voice</div>
