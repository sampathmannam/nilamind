...
// Baseline (calm/anxious/low/crisis/unknown) — the orb's normal gentle motion.
const BASELINE: FaceMotion = { breatheSec: 3, spinSec: 20, shimmerSec: 6, animate: true };
// Elevated — every ambient motion is slowed so the orb visibly settles.
const SETTLED: FaceMotion = { breatheSec: 6, spinSec: 40, shimmerSec: 12, animate: true };
