...
export default function CrisisOverlay({
  ...
  // silently — offerPostCrisisCheckIn() only fires if this is explicitly checked before "I'm okay for now".
      ...
      <div className="max-w-md mx-auto px-4 py-6 pb-24 space-y-6">
        ...
        <div className="pt-4 text-center space-y-3">
          {/* Opt-in, unchecked-by-default post-crisis check-in (2026-07-12 Wave 3, Task 1.4) — never scheduled
              unless explicitly checked here BEFORE tapping "I'm okay for now" (which still closes immediately
