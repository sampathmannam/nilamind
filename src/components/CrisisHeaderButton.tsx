  ...
  return (
    <div className={`flex items-center gap-1.5 ${className}`}>
      ...
      <button
        ...
        className="flex items-center gap-1.5 rounded-full border border-danger/30 bg-danger/10 hover:bg-danger/20 text-rose-300 px-3 min-w-[44px] min-h-[44px] text-xs font-semibold transition-all cursor-pointer focus-visible:outline-2 focus-visible:outline-danger focus-visible:outline-offset-2 active:scale-95 active:brightness-90"
      >
