...
export default function MedicationAdherenceScreen() {
  ...
  return (
    <div className="space-y-5 max-w-md mx-auto" id="medication-adherence-screen">
      ...
      {showForm && (
        <div className="bg-fill/60 border border-line-strong rounded-2xl p-4 space-y-3">
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="text-[11px] uppercase tracking-wider text-ink-faint font-semibold">Name</label>
              <input
                value={name}
            ...
            <div>
              <label className="text-[11px] uppercase tracking-wider text-ink-faint font-semibold">Dose</label>
              <input
                value={dose}
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="text-[11px] uppercase tracking-wider text-ink-faint font-semibold">Time</label>
              <input
                type="time"
                value={time}
            ...
            <div>
              <label className="text-[11px] uppercase tracking-wider text-ink-faint font-semibold">Schedule</label>
              <select
                value={schedule}
            ...
            <div key={med.id} className={`bg-fill/60 border rounded-2xl p-4 space-y-3 ${med.active ? "border-line-strong" : "border-line-strong/40 opacity-70"}`}>
              <div className="flex items-start justify-between">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-ink">{med.name} {med.dose}</p>
                    ...
                    <p className="text-[11px] text-ink-faint mt-1">7-day adherence: {adherence.get(med.id) ?? 0}%</p>
                  </div>
                </div>
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="px-3 py-2 rounded-xl bg-line-strong hover:bg-rose-600 text-ink-2 hover:text-white text-xs font-semibold transition-colors cursor-pointer"
                >
