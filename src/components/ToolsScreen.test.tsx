...
describe("ToolsScreen", () => {
  ...
  it("renders all 3 sections: Calm, Track, Skills", async () => {
    render(<ToolsScreen {...props} />);
    await waitFor(() => {
  ...
  it("renders correct number of tools in Calm section", async () => {
    render(<ToolsScreen {...props} />);
    await waitFor(() => {
  ...
  it("renders correct number of tools in Track section", async () => {
    render(<ToolsScreen {...props} />);
    await waitFor(() => {
  ...
  it("renders correct number of tools in Skills section", async () => {
    render(<ToolsScreen {...props} />);
    await waitFor(() => {
  ...
  it("each tool row is tappable and calls go with the right target", async () => {
    render(<ToolsScreen {...props} />);
    await waitFor(() => {
  ...
  it("does not render a crisis button at the bottom", async () => {
    render(<ToolsScreen {...props} />);
    await waitFor(() => {
